...
class DeclContext {
  ...
  class FunctionDeclBitfields {
    ...
    /// If an error occurred and was ignored, in a previous instantiation, we
    /// need to instantiate this function definition again.
    LLVM_PREFERRED_TYPE(bool)
    uint64_t RequiresReinstantiation : 1;
  };
