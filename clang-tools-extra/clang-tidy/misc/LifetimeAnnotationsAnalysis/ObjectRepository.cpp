...
public:
  ...
  void AddObjectForVar(clang::VarDecl *var) {
    ...
    case clang::SC_PrivateExtern:
      ...
      lifetime_factory = [](const clang::Expr *) { return Lifetime::Static(); };
      break;
    default:
  ...
  void
  TraverseCXXMemberInitializers(const clang::CXXConstructorDecl *constructor) {
...
const Object *
ObjectRepository::GetDeclObject(const clang::ValueDecl *decl) const {
...
const Object *
ObjectRepository::GetCallExprArgumentObject(const clang::CallExpr *expr,
...
const Object *
ObjectRepository::GetCallExprRetObject(const clang::Expr *expr) const {
...
ObjectRepository::GetCallExprVirtualLifetimes(const clang::Expr *expr) const {
...
const Object *
ObjectRepository::GetCallExprThisPointer(const clang::CallExpr *expr) const {
...
const Object *
ObjectRepository::GetFieldObject(const Object *struct_object,
...
ObjectSet
ObjectRepository::GetFieldObject(const ObjectSet &struct_objects,
                                 const clang::FieldDecl *field) const {
  ObjectSet ret;
...
const Object *
ObjectRepository::GetBaseClassObject(const Object *struct_object,
...
GetFieldLifetimeArguments(const clang::FieldDecl *field) {
...
ObjectRepository::GetFieldObjectInternal(const Object *struct_object,
                                         const clang::FieldDecl *field) const {
